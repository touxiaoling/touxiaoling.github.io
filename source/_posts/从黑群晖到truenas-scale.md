...
电源是买机箱的时候送的益衡300W模块.整机功耗加硬盘100W左右,应该是妥妥的够了.
做好系统休眠的话,待机功耗应该是30~40w左右.  
## 关于RAID
...
### 定时快照设置
### 硬盘待机设置
企业硬盘一块大概就有5~8w的功耗,8块就40~60w了,光硬盘功耗一年的电费就要300块左右了,所以说,如果不是担心资料的话,网盘是个性价比很高的东西了.
虽然企业盘一般都是不推荐待机的,因为频繁启停会比较伤硬盘,另外企业盘本身也是为24小时运转制作的,所以一直运转的状态下反而要比待机的状态寿命要更有保证.
但是,家用对功耗很敏感,而且存储的电影啊什么的,放在那里基本上就是万年不会打开了,所以,待机还是要加上的.
